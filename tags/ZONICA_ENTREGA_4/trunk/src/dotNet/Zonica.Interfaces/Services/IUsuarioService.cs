...
namespace Zonica.Interfaces.Services {
	...
	public interface IUsuarioService : IService {
		...
		/// <summary>
		/// Obtinene la cantidad de usuarios registrados en el sistema.
		/// </summary>
		/// <returns>la cantidad de usuarios registrados</returns>
		Int32 GetCantidadUsuariosRegistrados();
		
		/// <summary>
		/// Obtinene la cantidad de usuarios registrados en el sistema en el día de la fecha.
		/// </summary>
		/// <returns>la cantidad de usuarios registrados</returns>
		Int32 GetCantidadUsuariosRegistradosHoy();
	}
}