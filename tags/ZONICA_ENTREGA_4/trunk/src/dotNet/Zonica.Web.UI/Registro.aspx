...
<P>Gracias por tu interés en Zónica.</P>
<P>Esta guía consiste en tres simples que te convertirán en un miembro de 
Zónica. Solo tomará unos segundos.</P>
...
<DIV class="errorSummary">
	...
	<asp:Label id=lblUsuarioDuplicado Runat="server" Visible="False" EnableViewState="False">
		Este nombre de usuario ya fue utilizado por alguien más. Por favor ingresá otro nombre.
	</asp:Label>
</DIV>
</FIELDSET> 
...
<H4>Descargá el plug in.</H4>
<P>Ahora que creaste tu usuario sólo queda descargar e instalar el plug-in. Es 
muy fácil!</P>
<P>Podés descargarlo haciendo click <asp:LinkButton id=lnkDownload runat="server">Acá</asp:LinkButton></P>
...
<H4>Listo!</H4>
<P>¿Ya descargaste e instalaste el plug-in? ¡Buenísimo! Ahora sólo resta 
...
click&nbsp;<A href="misDatos.aspx">acá</A>, o en el botón "¡Listo!", te vamos a 
redireccionar a tu perfil, donde&nbsp;podés cargar en qué región&nbsp;vivís, y datos de conntacto, entre otras cosas. ¡Nos vemos pronto!</P>
