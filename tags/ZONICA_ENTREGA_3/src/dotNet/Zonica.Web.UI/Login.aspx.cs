		...
		private void btnLogin_Click(object sender, System.EventArgs e)
		{
			if (Page.IsValid)
			{
				...
				try {
					...
					Session[SessionEntries.UserName] = this.txtUserName.Text.Trim();
					Session[SessionEntries.UserID] = usuario.Id;

					if (this.Request.QueryString[RequestEntries.RedirectPage] != null && this.Request.QueryString[RequestEntries.RedirectPage] != string.Empty)
						Response.Redirect(this.Request.QueryString[RequestEntries.RedirectPage]);
					else
