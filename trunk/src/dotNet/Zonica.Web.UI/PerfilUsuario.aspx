		...
		<div id="wrapper">
		    ...
		    <div id="contenido">
				...
				<asp:Panel ID="pnlUsuarioEncontrado" Runat="server" Visible="True">
					...
					<uc1:RatingGrid id="rtgAmigos" runat="server" CssClass="rating" Title="Usuarios que escuchan la misma música" UrlTemplate="PerfilUsuario.aspx?id={0}" NameProperty="Nombre" IdentifierProperty="Id" DisableLinks="false"/>
					<uc1:RatingGrid id="rtgEscuchas" runat="server" CssClass="rating" Title="Últimas escuchas" UrlTemplate="Cancion.aspx?id={0}" NameProperty="Nombre" IdentifierProperty="Id" DisableLinks="true"/>
					<div class=centerContent> 
						...
						<LABEL>Cantidad de escuchas realizadas:</LABEL><asp:Label id="lblCantidadEscuchas" Runat="server" CssClass="readOnlyField">[No tiene escuchas aún]</asp:Label>
