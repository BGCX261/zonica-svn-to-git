...
namespace Zonica.Interfaces.Services {
	...
	public interface IMusicaService : IService {
		...
		/// por aquellas personas que escuchan al <see cref="Artista">Artista</see> especificado.
		/// </summary>
		/// <param name="artista">el <see cref="Artista">Artista</see> del cual se quiere la información</param>
		/// <returns>una lista de <see cref="ItemRanking">ItemRanking</see></returns>
		IList GetArtistasSimilaresA(Artista artista);
	}
}